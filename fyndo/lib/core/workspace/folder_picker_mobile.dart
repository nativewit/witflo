...
class FolderPickerMobile implements FolderPicker {
  ...
  Future<String> getDefaultWorkspaceDirectory() async {
    try {
      // iOS: /var/mobile/Containers/Data/Application/<UUID>/Documents/FyndoWorkspace
      // Android: /data/user/0/com.fyndo.app/files/FyndoWorkspace
      final Directory appDocDir = await getApplicationDocumentsDirectory();
      final String workspacePath = p.join(appDocDir.path, 'FyndoWorkspace');

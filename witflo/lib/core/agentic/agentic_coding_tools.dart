...
//
// OVERVIEW:
// This file centralizes all AI-powered development tooling for Witflo:
// - Marionette MCP: UI testing, screenshots, element detection
// - MCP Toolkit: Flutter-specific testing capabilities
// - Custom Witflo MCP Tools: Domain-specific inspection (vaults, crypto, db)
//
// USAGE:
...
import 'package:witflo_app/core/mcp/app_mcp_tools.dart';
...
class AgenticCodingTools extends StatefulWidget {
  ...
  static Future<void> initialize() async {
    ...
    // Register custom Witflo MCP tools
    initializeAppMCPTools();
    ...
    log.info(
      ...
      'Witflo MCP (9 domain tools: vault, sync, crypto, hierarchy, app, logger, db, widget inspector) - '
      '12+ tools total',
    );
  }
}

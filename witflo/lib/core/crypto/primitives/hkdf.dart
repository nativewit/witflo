...
// Vault Key (VK) → HKDF
//   ├─ info="witflo.content.v2" → Content Key (CK)
//   ├─ info="witflo.notebook.{id}.v2" → Notebook Key (NK)
//   ├─ info="witflo.group.{id}.v2" → Group Key (GK)
//   └─ info="witflo.share.{id}.v2" → Note Share Key (NSK)
//
// CONTEXT STRINGS:

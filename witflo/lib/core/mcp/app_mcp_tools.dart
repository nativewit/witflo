...
import 'package:witflo_app/core/mcp/logger_mcp_tool.dart';
import 'package:witflo_app/core/mcp/widget_inspector_mcp_tool.dart';
...
/// Initialize custom Witflo MCP tools
/// Call this from main.dart in debug mode
void initializeAppMCPTools() {
    ...
    entries: {
      ...
      MCPCallEntry.tool(
        definition: MCPToolDefinition(
          ...
          description: 'Verify Witflo hierarchy: Vaults -> Notebooks -> Notes',
          inputSchema: ObjectSchema(properties: {}),
        ),
        handler: (params) async {
          try {
